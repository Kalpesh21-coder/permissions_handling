                    ...
                    <div>
                        ...
                        <div class="my-3">
                            <input autofocus name="author" placeholder="author name"
                                class="border-gray-300 shadow-sm w-1/2 rounded-lg" value="{{ old('author',$article->author) }}"
                                type="text">
                        ...
                        <div class="my-3">
                            <input  name="title" placeholder="title"
                                class="border-gray-300 shadow-sm w-1/2 rounded-lg" value="{{ old('title', $article->title) }}"
                                type="text">
                        ...
                        <div class="my-3">
                            <textarea  name="text" placeholder="content" cols="30" rows="7"
                                ...
                                type="text">{{ old('text', $article->text) }}</textarea>
